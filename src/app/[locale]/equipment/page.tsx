...
const equipment: Aircraft[] = [
  // Самолёты
  { name: 'Ан-2', type: 'Самолёт', category: 'plane', specs: [['Скорость', '180 км/ч'], ['Дальность', '845 км'], ['Экипаж', '2 чел.'], ['Вместимость', '12 чел.']], img: 'https://aviales.kz/uploads/posts/2025-03/1740983100_1d54e5a8-6001-4326-871d-5c442eec8053.jpg' },
  { name: 'PA-68 «Partenavia»', type: 'Самолёт', category: 'plane', specs: [['Скорость', '300 км/ч'], ['Дальность', '2 000 км'], ['Экипаж', '2 чел.'], ['Вместимость', '6 чел.']] },
  // Вертолёты
  { name: 'Ми-8', type: 'Вертолёт', category: 'heli', specs: [['Скорость', '250 км/ч'], ['Дальность', '465 км'], ['Экипаж', '3 чел.'], ['Груз', '4 000 кг']], img: 'https://aviales.kz/uploads/posts/2026-02/1772079209_img_2683.jpg' },
  { name: 'Ми-2', type: 'Вертолёт', category: 'heli', specs: [['Скорость', '200 км/ч'], ['Дальность', '580 км'], ['Экипаж', '1 чел.'], ['Вместимость', '8 чел.']] },
  { name: 'EC-130', type: 'Вертолёт', category: 'heli', specs: [['Скорость', '235 км/ч'], ['Дальность', '610 км'], ['Экипаж', '1 чел.'], ['Вместимость', '7 чел.']] },
  { name: 'EC-145', type: 'Вертолёт', category: 'heli', specs: [['Скорость', '250 км/ч'], ['Дальность', '680 км'], ['Экипаж', '2 чел.'], ['Вместимость', '9 чел.']] },
  { name: 'AS-350', type: 'Вертолёт', category: 'heli', specs: [['Скорость', '245 км/ч'], ['Дальность', '660 км'], ['Экипаж', '1 чел.'], ['Вместимость', '5 чел.']] },
  { name: 'BO-105', type: 'Вертолёт', category: 'heli', specs: [['Скорость', '240 км/ч'], ['Дальность', '575 км'], ['Экипаж', '2 чел.'], ['Вместимость', '4 чел.']] },
];
